        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu my-5">
                <ul>
                    ...
                    <li class="p-2 my-1"><a href="inbox.php" class="active"><span><i class="fas fa-envelope-open-text"></i></span><span class="px-2">Inbox</span></a>
                    </li>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th scope="row"><?php echo $row['sender'] ; ?></th>
