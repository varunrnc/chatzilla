        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu my-5">
                <ul>
                    ...
                    <li class="p-2 my-1"><a href="sent.php" class="active"><span><i class="fas fa-paper-plane"></i></span><span class="px-2">Sent</span></a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th scope="row"><?php echo $row['receiver'] ; ?></th>
